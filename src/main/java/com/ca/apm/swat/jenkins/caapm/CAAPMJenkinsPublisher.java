...
public class CAAPMJenkinsPublisher extends Recorder {
    ...
    public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener)
        ...
        try {
            ...
            CAAPMBuildAction buildAction = new CAAPMBuildAction(build, report);
    ...
    public Action getProjectAction(AbstractProject<?, ?> project) {
        ...
        return new CAAPMProjectAction(project, "10", dummyMetrics);
    }
    ...
    public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public CAAPMJenkinsPublisher newInstance(StaplerRequest req, JSONObject formData) throws FormException {
            ...
            try {
                ...
                LOGGER.log(Level.FINE, "##### new formData " + formData);
                ...
                CAAPMJenkinsPublisher caAPMPublisher = new CAAPMJenkinsPublisher(momHost, momPort, username, password,
                                                                                 ...
                                                                                 singleMetricValue, singleMetricOperator, multiMetricName1, multiMetricName2, multiMetricOperator, multiMetricRatio);
